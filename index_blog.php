...
<body class="text-white min-h-screen flex flex-col items-center p-4 sm:p-8">
    ...
    <a href="https://localhost" target="_blank" rel="noopener noreferrer" class="fixed top-4 right-4 z-50 p-3 glass-card hover:bg-white/20 transition-colors font-semibold text-sm rounded-lg">
        Se connecter
    </a>
    ...
    <main class="w-full max-w-4xl mx-auto">
        <header class="glass-card text-center p-8 mb-12">
            <h1 class="text-4xl md:text-5xl font-bold mb-4">Votre Site</h1>
            <p class="text-lg md:text-xl text-gray-200">Description de votre site</p>
        </header>
